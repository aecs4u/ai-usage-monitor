...
from ai_usage_monitor.terminal.themes import get_cost_style, get_velocity_indicator
...
class LoadingScreenComponent:
    ...
    def create_loading_screen_renderable(
        ...
        from ai_usage_monitor.ui.display_controller import ScreenBufferManager
...
class AdvancedCustomLimitDisplay:
    ...
    def _is_limit_session(self, session: Dict[str, Any]) -> bool:
        ...
        from ai_usage_monitor.core.plans import (
            COMMON_TOKEN_LIMITS,
