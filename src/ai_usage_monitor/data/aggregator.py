...
from ai_usage_monitor.core.models import SessionBlock, UsageEntry, normalize_model_name
...
class UsageAggregator:
    ...
    def aggregate(
        ...
        # Aggregate based on mode with optional date filters
        if self.aggregation_mode == "daily":
            return self.aggregate_daily(entries, self.from_date, self.to_date)
        elif self.aggregation_mode == "monthly":
            return self.aggregate_monthly(entries, self.from_date, self.to_date)
        else:
