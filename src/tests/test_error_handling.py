...
from ai_usage_monitor.error_handling import ErrorLevel, report_error
...
class TestReportError:
    ...
    @patch("ai_usage_monitor.error_handling.logging.getLogger")
    ...
    def test_report_error_none_exception(self) -> None:
        ...
        with patch(
            "ai_usage_monitor.error_handling.logging.getLogger"
        ) as mock_get_logger:
            mock_logger = Mock()
            mock_get_logger.return_value = mock_logger
