...
from ai_usage_monitor.core.models import (
    BurnRate,
    CostMode,
    SessionBlock,
    TokenCounts,
...
from ai_usage_monitor.data.analysis import (
...
class TestAnalyzeUsage:
    ...
    @patch("ai_usage_monitor.data.analysis.load_usage_entries")
    @patch("ai_usage_monitor.data.analysis.SessionAnalyzer")
    @patch("ai_usage_monitor.data.analysis.BurnRateCalculator")
...
class TestCreateResult:
    ...
    @patch("ai_usage_monitor.data.analysis._convert_blocks_to_dict_format")
...
class TestBlockConversion:
    ...
    @patch("ai_usage_monitor.data.analysis._create_base_block_dict")
    @patch("ai_usage_monitor.data.analysis._add_optional_block_data")
