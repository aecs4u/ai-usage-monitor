...
from ai_usage_monitor.core.calculations import (
    BurnRateCalculator,
    _calculate_total_tokens_in_hour,
    _process_block_for_burn_rate,
    calculate_hourly_burn_rate,
)
from ai_usage_monitor.core.models import BurnRate, TokenCounts, UsageProjection
...
class TestBurnRateCalculator:
    ...
    @patch("ai_usage_monitor.core.calculations.datetime")
...
class TestHourlyBurnRateCalculation:
    ...
    @patch("ai_usage_monitor.core.calculations._calculate_total_tokens_in_hour")
    ...
    @patch("ai_usage_monitor.core.calculations._process_block_for_burn_rate")
    ...
    @patch("ai_usage_monitor.core.calculations._parse_block_start_time")
    ...
    @patch("ai_usage_monitor.core.calculations._determine_session_end_time")
    @patch("ai_usage_monitor.core.calculations._parse_block_start_time")
...
class TestP90Calculator:
    ...
    def test_p90_config_creation(self) -> None:
        ...
        from ai_usage_monitor.core.p90_calculator import P90Config
    ...
    def test_did_hit_limit_true(self) -> None:
        ...
        from ai_usage_monitor.core.p90_calculator import _did_hit_limit
    ...
    def test_extract_sessions_basic(self) -> None:
        ...
        from ai_usage_monitor.core.p90_calculator import _extract_sessions
    ...
    def test_calculate_p90_from_blocks_with_hits(self) -> None:
        ...
        from ai_usage_monitor.core.p90_calculator import (
            P90Config,
    ...
    def test_p90_calculator_init(self) -> None:
        ...
        from ai_usage_monitor.core.p90_calculator import P90Calculator
    ...
    def test_p90_calculator_custom_config(self) -> None:
        ...
        from ai_usage_monitor.core.p90_calculator import P90Calculator, P90Config
