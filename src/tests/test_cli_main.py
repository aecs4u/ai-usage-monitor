...
from ai_usage_monitor.cli.main import main
...
class TestMain:
    ...
    def test_version_flag(self) -> None:
        ...
        with patch("builtins.print") as mock_print:
            ...
            assert "ai-usage-monitor" in mock_print.call_args[0][0]
    ...
    @patch("ai_usage_monitor.core.settings.Settings.load_with_last_used")
    ...
    def test_successful_main_execution(self, mock_load_settings: Mock) -> None:
        ...
        actual_module = sys.modules["ai_usage_monitor.cli.main"]
        ...
        try:
            with (
                patch("ai_usage_monitor.terminal.manager.setup_terminal"),
                patch("ai_usage_monitor.terminal.themes.get_themed_console"),
                patch("ai_usage_monitor.ui.display_controller.DisplayController"),
                patch(
                    "ai_usage_monitor.monitoring.orchestrator.MonitoringOrchestrator"
...
class TestFunctions:
    ...
    def test_get_standard_claude_paths(self) -> None:
        ...
        from ai_usage_monitor.cli.main import get_standard_claude_paths
    ...
    def test_discover_claude_data_paths_no_paths(self) -> None:
        ...
        from ai_usage_monitor.cli.main import discover_claude_data_paths
