...
class TestLoadUsageEntries:
    ...
    @patch("ai_usage_monitor.data.reader._find_jsonl_files")
    @patch("ai_usage_monitor.data.reader._process_single_file")
    ...
    def test_load_usage_entries_with_cutoff_time(
        ...
        with patch("ai_usage_monitor.data.reader.datetime") as mock_datetime:
    ...
    def test_load_usage_entries_default_path(self) -> None:
        with patch("ai_usage_monitor.data.reader._find_jsonl_files") as mock_find:
...
class TestLoadAllRawEntries:
    ...
    def test_load_all_raw_entries_file_error(self, mock_find_files: Mock) -> None:
        ...
        with patch("builtins.open", side_effect=OSError("File not found")):
            with patch("ai_usage_monitor.data.reader.logger") as mock_logger:
                result = load_all_raw_entries("/test/path")
...
class TestProcessSingleFile:
    ...
    def test_process_single_file_valid_data(
        ...
        with (
            ...
            patch(
                "ai_usage_monitor.data.reader._should_process_entry", return_value=True
            ),
            patch(
                "ai_usage_monitor.data.reader._map_to_usage_entry",
                return_value=sample_entry,
            ),
            patch("ai_usage_monitor.data.reader._update_processed_hashes"),
        ):
    ...
    def test_process_single_file_filtered_entries(self, mock_components):
        ...
        with (
            patch("builtins.open", mock_open(read_data=jsonl_content)),
            patch(
                "ai_usage_monitor.data.reader._should_process_entry", return_value=False
            ),
        ):
            entries, raw_data = _process_single_file(
                test_file,
    ...
    def test_process_single_file_invalid_json(self, mock_components):
        ...
        with (
            ...
            patch("ai_usage_monitor.data.reader._map_to_usage_entry", return_value=None),
        ):
            entries, raw_data = _process_single_file(
                test_file,
                CostMode.AUTO,
    ...
    def test_process_single_file_read_error(self, mock_components):
        ...
        with patch("builtins.open", side_effect=OSError("File not found")):
            with patch("ai_usage_monitor.data.reader.report_file_error") as mock_report:
                entries, raw_data = _process_single_file(
                    test_file,
                    CostMode.AUTO,
                    None,
...
class TestShouldProcessEntry:
    ...
    def test_should_process_entry_no_cutoff_no_hash(
        ...
        with patch(
            "ai_usage_monitor.data.reader._create_unique_hash", return_value="hash_1"
        ):
    ...
    def test_should_process_entry_with_time_filter_pass(
        ...
        with patch(
            "ai_usage_monitor.data.reader.TimestampProcessor"
    ...
    def test_should_process_entry_with_duplicate_hash(self, timezone_handler):
        ...
        with patch(
            "ai_usage_monitor.data.reader._create_unique_hash", return_value="msg_1:req_1"
        ):
            result = _should_process_entry(
    ...
    def test_should_process_entry_invalid_timestamp(self, timezone_handler):
        ...
        with patch(
            "ai_usage_monitor.core.data_processors.TimestampProcessor"
        ) as mock_processor_class:
            mock_processor = Mock()
...
class TestUpdateProcessedHashes:
    ...
    def test_update_processed_hashes_valid_hash(self) -> None:
        ...
        with patch(
            "ai_usage_monitor.data.reader._create_unique_hash",
    ...
    def test_update_processed_hashes_no_hash(self) -> None:
        ...
        with patch("ai_usage_monitor.data.reader._create_unique_hash", return_value=None):
            _update_processed_hashes(data, processed_hashes)
...
class TestMapToUsageEntry:
    ...
    def test_map_to_usage_entry_valid_data(
        ...
        with patch(
            ...
            with patch(
                "ai_usage_monitor.data.reader.TokenExtractor"
                ...
                with patch(
                    "ai_usage_monitor.data.reader.DataConverter"
    ...
    def test_map_to_usage_entry_no_tokens(self, mock_components):
        ...
        with patch(
            ...
            with patch(
                "ai_usage_monitor.core.data_processors.TokenExtractor"
            ) as mock_token_extractor:
                mock_token_extractor.extract_tokens.return_value = {
                    "input_tokens": 0,
                    "output_tokens": 0,
    ...
    def test_map_to_usage_entry_minimal_data(self, mock_components):
        ...
        with patch(
            ...
            with patch(
                ...
                with patch(
                    "ai_usage_monitor.core.data_processors.DataConverter"
                ) as mock_data_converter:
            ...
            with patch(
                ...
                with patch(
                    ...
                    with patch(
                        ...
                        with patch(
                            "ai_usage_monitor.core.pricing.PricingCalculator"
...
class TestPerformanceAndEdgeCases:
    ...
    def test_memory_efficiency(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch(
                "ai_usage_monitor.data.reader._process_single_file"
            ) as mock_process:
...
class TestUsageEntryMapper:
    ...
    def mapper_components(self) -> Tuple[Any, Mock, Mock]:
        ...
        from ai_usage_monitor.data.reader import UsageEntryMapper
    ...
    def test_usage_entry_mapper_map_success(
        ...
        with patch("ai_usage_monitor.data.reader._map_to_usage_entry") as mock_map:
    ...
    def test_usage_entry_mapper_map_failure(self, mapper_components):
        ...
        with patch("ai_usage_monitor.data.reader._map_to_usage_entry", return_value=None):
            result = mapper.map(data, CostMode.AUTO)
    ...
    def test_usage_entry_mapper_extract_model(self, mapper_components):
        ...
        with patch("ai_usage_monitor.data.reader.DataConverter") as mock_converter:
                ...
                with patch(
                    ...
                    with patch(
                        ...
                        with patch(
                            ...
                            with patch(
                                "ai_usage_monitor.data.reader.PricingCalculator"
                            ) as mock_pricing_class:
                                mock_pricing = Mock()
...
class TestDataProcessors:
    ...
    def test_timestamp_processor_init(self):
        ...
        from ai_usage_monitor.core.data_processors import TimestampProcessor
    ...
    def test_token_extractor_basic_extraction(self):
        ...
        from ai_usage_monitor.core.data_processors import TokenExtractor
    ...
    def test_data_converter_extract_model_name(self):
        ...
        from ai_usage_monitor.core.data_processors import DataConverter
