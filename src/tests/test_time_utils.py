...
class TestTimeFormatDetector:
    ...
    @patch("ai_usage_monitor.utils.time_utils.HAS_BABEL", True)
    @patch("ai_usage_monitor.utils.time_utils.get_timezone_location")
    ...
    @patch("ai_usage_monitor.utils.time_utils.HAS_BABEL", False)
...
class TestTimezoneHandler:
    ...
    def test_init_custom_invalid(self) -> None:
        ...
        with patch("ai_usage_monitor.utils.time_utils.logger") as mock_logger:
    ...
    def test_parse_timestamp_invalid_iso(self) -> None:
        ...
        handler = TimezoneHandler()
        with patch("ai_usage_monitor.utils.time_utils.logger"):
...
class TestFormattingUtilities:
    ...
    def test_format_display_time_12h_with_seconds(self) -> None:
        ...
        with patch(
            "ai_usage_monitor.utils.time_utils.get_time_format_preference",
            return_value=True,
        ):
