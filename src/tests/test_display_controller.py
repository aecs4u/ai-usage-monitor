...
from ai_usage_monitor.ui.display_controller import (
    DisplayController,
    LiveDisplayManager,
    ScreenBufferManager,
    SessionCalculator,
...
class TestDisplayController:
    ...
    def controller(self) -> Any:
        with patch("ai_usage_monitor.ui.display_controller.NotificationManager"):
    ...
    @patch("ai_usage_monitor.ui.display_controller.calculate_hourly_burn_rate")
    ...
    @patch("ai_usage_monitor.ui.display_controller.Plans.is_valid_plan")
    ...
    @patch("ai_usage_monitor.ui.display_controller.TimezoneHandler")
    @patch("ai_usage_monitor.ui.display_controller.get_time_format_preference")
    @patch("ai_usage_monitor.ui.display_controller.format_display_time")
    ...
    @patch("ai_usage_monitor.ui.display_controller.normalize_model_name")
    ...
    @patch("ai_usage_monitor.ui.display_controller.Plans.is_valid_plan")
    @patch("ai_usage_monitor.core.plans.get_cost_limit")
    @patch("ai_usage_monitor.ui.display_controller.Plans.get_message_limit")
...
class TestLiveDisplayManager:
    ...
    @patch("ai_usage_monitor.ui.display_controller.Live")
...
class TestScreenBufferManager:
    ...
    @patch("ai_usage_monitor.terminal.themes.get_themed_console")
    @patch("ai_usage_monitor.ui.display_controller.Text")
    @patch("ai_usage_monitor.ui.display_controller.Group")
...
class TestDisplayControllerAdvanced:
    ...
    @patch("ai_usage_monitor.ui.display_controller.AdvancedCustomLimitDisplay")
    @patch("ai_usage_monitor.ui.display_controller.Plans.get_message_limit")
    @patch("ai_usage_monitor.core.plans.get_cost_limit")
    ...
    def test_process_active_session_data_comprehensive(self, controller):
        ...
        with patch(
            "ai_usage_monitor.ui.display_controller.calculate_hourly_burn_rate"
        ) as mock_burn:
...
class TestSessionCalculator:
    ...
    def test_calculate_cost_predictions_with_cost(self, calculator):
        ...
        with patch("ai_usage_monitor.ui.display_controller.datetime") as mock_datetime:
...
@patch("ai_usage_monitor.ui.display_controller.ScreenBufferManager")
def test_create_screen_renderable_legacy(mock_manager_class):
    ...
    from ai_usage_monitor.ui.display_controller import create_screen_renderable
