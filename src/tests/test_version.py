...
from ai_usage_monitor._version import _get_version_from_pyproject, get_version
...
def test_version_consistency() -> None:
    ...
    from ai_usage_monitor import __version__ as version1
    from ai_usage_monitor._version import __version__ as version2
